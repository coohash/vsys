...
> 2. 由于脚本需要读取明文私钥，请在干净的电脑/服务器上运行。使用后建议立即删除包含私钥的文件。
...
* 公共节点不是永久稳定的，使用前，请务必进行以下两步人工检查：
 ...
 <small> 1. 🔍 检查接口是否活着：直接把节点地址复制到浏览器里打开。能打开 Swagger页面，说明节点在线。</small>
 <small> 2. 🔍 检查数据是否同步：在节点地址后面加上 /blocks/height ”获取区块高度，若与 VSYS 官网浏览器（explorer.v.systems）一致，即为最新，可放心使用。</small>
